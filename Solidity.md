...
- pop: добавляет значение в конец массива.  
- push: выталкивает значения с конца массива, уменьшая длинну массива на 1.  
...
- require: проверяет условиие и выдает ошибку если одно из требований не соблюдено.
```
owner = msg.sender;
